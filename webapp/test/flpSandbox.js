		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#comsapktodsodataexample-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsapktodsodataexample-display": {
								"semanticObject": "comsapktodsodataexample",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.sap.kt.ods.odataexample",
									"url": sap.ui.require.toUrl("com/sap/kt/ods/odataexample")
								}
							}
						}
					}
